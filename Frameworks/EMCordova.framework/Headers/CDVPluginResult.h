...
+ (instancetype)lackOfNecessaryParametersResultWithStatus:(CDVCommandStatus)statusOrdinal;
+ (instancetype)invalidParameterTypeResultWithStatus:(CDVCommandStatus)statusOrdinal;
+ (instancetype)resultWithLackOfNecessaryParameters;
+ (instancetype)resultWithInvalidParameterType;
