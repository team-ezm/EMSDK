...
#pragma mark - CDVFilesystemURL

@interface CDVFilesystemURL : NSObject

- (instancetype)initWithString:(NSString*)strURL;
...
@property (nonatomic, strong) NSString *fileSystemName;
@property (nonatomic, strong) NSString *fullPath;
@end



#pragma mark - CDVFilesystemURLProtocol

@interface CDVFilesystemURLProtocol : NSURLProtocol
@end


#pragma mark - CDVFileSystemProtocol
